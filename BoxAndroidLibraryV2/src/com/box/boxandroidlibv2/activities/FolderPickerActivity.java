...
/**
 * This class is used to choose a particular folder from the user's account and
 * when chosen will return a result with a BoxAndroidFolder in the extra
...
public class FolderPickerActivity extends FilePickerActivity {
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		if (requestCode == FOLDER_PICKER_REQUEST_CODE) {
			if (resultCode == Activity.RESULT_OK) {
				// if someone further down the chain has chosen a folder then
				// send result back.
	...
	protected void initializeViews() {
		...
		this.findViewById(R.id.btnChoose).setOnClickListener(
				new View.OnClickListener() {
					...
					public void onClick(View v) {
						...
						Bundle b = new Bundle();
						// intent.putExtra(EXTRA_BOX_ANDROID_FOLDER,
						// mCurrentFolder);
						b.putParcelable(EXTRA_BOX_ANDROID_FOLDER,
								mCurrentFolder);
						intent.putExtras(b);
	 ...
	 */
	protected class FolderPickerBoxListItemAdapter extends
			FolderNavigationActivity.FolderNavigationBoxListItemAdapter {

		public FolderPickerBoxListItemAdapter(Activity context,
		...
		public boolean isEnabled(int position) {
			return getItem(position).getBoxItem() != null
					&& getItem(position).getBoxItem() instanceof BoxAndroidFolder;
		}
